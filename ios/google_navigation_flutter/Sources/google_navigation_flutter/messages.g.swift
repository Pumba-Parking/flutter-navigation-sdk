...
struct StyleSpanStrokeStyleDto {
  ...
  static func fromList(_ list: [Any?]) -> StyleSpanStrokeStyleDto? {
    let solidColor: Int64? = isNullish(list[0]) ? nil : (list[0] is Int64? ? list[0] as! Int64? : Int64(list[0] as! Int32))
    let fromColor: Int64? = isNullish(list[1]) ? nil : (list[1] is Int64? ? list[1] as! Int64? : Int64(list[1] as! Int32))
    let toColor: Int64? = isNullish(list[2]) ? nil : (list[2] is Int64? ? list[2] as! Int64? : Int64(list[2] as! Int32))
...
struct PolylineOptionsDto {
  ...
  static func fromList(_ list: [Any?]) -> PolylineOptionsDto? {
    ...
    let strokeColor: Int64? = isNullish(list[3]) ? nil : (list[3] is Int64? ? list[3] as! Int64? : Int64(list[3] as! Int32))
    var strokeJointType: StrokeJointTypeDto? = nil
...
struct RoutingOptionsDto {
  ...
  static func fromList(_ list: [Any?]) -> RoutingOptionsDto? {
    ...
    if let alternateRoutesStrategyRawValue = alternateRoutesStrategyEnumVal {
      alternateRoutesStrategy = AlternateRoutesStrategyDto(rawValue: alternateRoutesStrategyRawValue)!
    }
    var routingStrategy: RoutingStrategyDto? = nil
    ...
    let locationTimeoutMs: Int64? = isNullish(list[7]) ? nil : (list[7] is Int64? ? list[7] as! Int64? : Int64(list[7] as! Int32))
...
struct NavigationWaypointDto {
  ...
  static func fromList(_ list: [Any?]) -> NavigationWaypointDto? {
    ...
    let preferredSegmentHeading: Int64? = isNullish(list[4]) ? nil : (list[4] is Int64? ? list[4] as! Int64? : Int64(list[4] as! Int32))
...
struct RouteSegmentTrafficDataDto {
  ...
  static func fromList(_ list: [Any?]) -> RouteSegmentTrafficDataDto? {
    ...
    let roadStretchRenderingDataList = list[1] as! [RouteSegmentTrafficDataRoadStretchRenderingDataDto?]
...
struct NavInfoDto {
  ...
  static func fromList(_ list: [Any?]) -> NavInfoDto? {
    ...
    let distanceToCurrentStepMeters: Int64? = isNullish(list[4]) ? nil : (list[4] is Int64? ? list[4] as! Int64? : Int64(list[4] as! Int32))
    let distanceToFinalDestinationMeters: Int64? = isNullish(list[5]) ? nil : (list[5] is Int64? ? list[5] as! Int64? : Int64(list[5] as! Int32))
    let distanceToNextDestinationMeters: Int64? = isNullish(list[6]) ? nil : (list[6] is Int64? ? list[6] as! Int64? : Int64(list[6] as! Int32))
    let timeToCurrentStepSeconds: Int64? = isNullish(list[7]) ? nil : (list[7] is Int64? ? list[7] as! Int64? : Int64(list[7] as! Int32))
    let timeToFinalDestinationSeconds: Int64? = isNullish(list[8]) ? nil : (list[8] is Int64? ? list[8] as! Int64? : Int64(list[8] as! Int32))
    let timeToNextDestinationSeconds: Int64? = isNullish(list[9]) ? nil : (list[9] is Int64? ? list[9] as! Int64? : Int64(list[9] as! Int32))
...
private class NavigationViewCreationApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return NavigationViewCreationApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return NavigationViewCreationApiCodecWriter(data: data)
  }
}

class NavigationViewCreationApiCodec: FlutterStandardMessageCodec {
  static let shared = NavigationViewCreationApiCodec(readerWriter: NavigationViewCreationApiCodecReaderWriter())
}
...
class NavigationViewCreationApiSetup {
  ...
  /// Sets up an instance of `NavigationViewCreationApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NavigationViewCreationApi?) {
    let createChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationViewCreationApi.create", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
private class MapViewApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return MapViewApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return MapViewApiCodecWriter(data: data)
  }
}
...
class MapViewApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MapViewApi?) {
    let awaitMapReadyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.awaitMapReady", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isMyLocationEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isMyLocationEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMyLocationEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMyLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getMyLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMapTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getMapType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMapTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMapType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMapStyleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMapStyle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isNavigationTripProgressBarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isNavigationTripProgressBarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNavigationTripProgressBarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationTripProgressBarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isNavigationHeaderEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isNavigationHeaderEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNavigationHeaderEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationHeaderEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isNavigationFooterEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isNavigationFooterEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNavigationFooterEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationFooterEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNavigationHeaderBackgroundColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationHeaderBackgroundColor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setNavigationHeaderBackgroundColorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let viewIdArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        let colorArg = args[1] is Int64 ? args[1] as! Int64 : Int64(args[1] as! Int32)
        do {
          try api.setNavigationHeaderBackgroundColor(viewId: viewIdArg, color: colorArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setNavigationHeaderBackgroundColorChannel.setMessageHandler(nil)
    }
    let setNavigationFooterBackgroundColorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationFooterBackgroundColor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setNavigationFooterBackgroundColorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let viewIdArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        let colorArg = args[1] is Int64 ? args[1] as! Int64 : Int64(args[1] as! Int32)
        do {
          try api.setNavigationFooterBackgroundColor(viewId: viewIdArg, color: colorArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setNavigationFooterBackgroundColorChannel.setMessageHandler(nil)
    }
    let isRecenterButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isRecenterButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setRecenterButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setRecenterButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isSpeedLimitIconEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isSpeedLimitIconEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setSpeedLimitIconEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setSpeedLimitIconEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isSpeedometerEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isSpeedometerEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setSpeedometerEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setSpeedometerEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isNavigationUIEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isNavigationUIEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNavigationUIEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setNavigationUIEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isMyLocationButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isMyLocationButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMyLocationButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isConsumeMyLocationButtonClickEventsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isConsumeMyLocationButtonClickEventsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setConsumeMyLocationButtonClickEventsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setConsumeMyLocationButtonClickEventsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isZoomGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isZoomGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setZoomGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setZoomGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isZoomControlsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isZoomControlsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setZoomControlsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setZoomControlsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isCompassEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isCompassEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCompassEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setCompassEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isRotateGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isRotateGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setRotateGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setRotateGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isScrollGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isScrollGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setScrollGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setScrollGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isScrollGesturesEnabledDuringRotateOrZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isScrollGesturesEnabledDuringRotateOrZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setScrollGesturesDuringRotateOrZoomEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setScrollGesturesDuringRotateOrZoomEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTiltGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isTiltGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTiltGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setTiltGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isMapToolbarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isMapToolbarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMapToolbarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMapToolbarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTrafficEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isTrafficEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTrafficEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setTrafficEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTrafficIncidentCardsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isTrafficIncidentCardsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTrafficIncidentCardsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setTrafficIncidentCardsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTrafficPromptsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isTrafficPromptsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setTrafficPromptsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setTrafficPromptsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isReportIncidentButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.isReportIncidentButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setReportIncidentButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setReportIncidentButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getVisibleRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getVisibleRegion", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let followMyLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.followMyLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let animateCameraToCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraToCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToCameraPositionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let viewIdArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        let cameraPositionArg = args[1] as! CameraPositionDto
        let durationArg: Int64? = isNullish(args[2]) ? nil : (args[2] is Int64? ? args[2] as! Int64? : Int64(args[2] as! Int32))
    ...
    let animateCameraToLatLngChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraToLatLng", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let animateCameraToLatLngBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraToLatLngBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToLatLngBoundsChannel.setMessageHandler { message, reply in
        ...
        let durationArg: Int64? = isNullish(args[3]) ? nil : (args[3] is Int64? ? args[3] as! Int64? : Int64(args[3] as! Int32))
    ...
    let animateCameraToLatLngZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraToLatLngZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let animateCameraByScrollChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraByScroll", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let animateCameraByZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraByZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraByZoomChannel.setMessageHandler { message, reply in
        ...
        let durationArg: Int64? = isNullish(args[4]) ? nil : (args[4] is Int64? ? args[4] as! Int64? : Int64(args[4] as! Int32))
    ...
    let animateCameraToZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.animateCameraToZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraToCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraToCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraToLatLngChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraToLatLng", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraToLatLngBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraToLatLngBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraToLatLngZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraToLatLngZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraByScrollChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraByScroll", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraByZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraByZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let moveCameraToZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.moveCameraToZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let showRouteOverviewChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.showRouteOverview", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMinZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getMinZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let resetMinMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.resetMinMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMinZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMinZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.addMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let updateMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.updateMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.removeMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clearMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clear", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.addPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let updatePolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.updatePolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removePolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.removePolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clearPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.addPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let updatePolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.updatePolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removePolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.removePolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clearPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.addCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let updateCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.updateCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.removeCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.clearCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let enableOnCameraChangedEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.enableOnCameraChangedEvents", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.setPadding", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.MapViewApi.getPadding", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
private class ImageRegistryApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return ImageRegistryApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return ImageRegistryApiCodecWriter(data: data)
  }
}
...
class ImageRegistryApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ImageRegistryApi?) {
    let registerBitmapImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.ImageRegistryApi.registerBitmapImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let unregisterImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.ImageRegistryApi.unregisterImage", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getRegisteredImagesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.ImageRegistryApi.getRegisteredImages", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearRegisteredImagesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.ImageRegistryApi.clearRegisteredImages", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
private class ViewEventApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return ViewEventApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return ViewEventApiCodecWriter(data: data)
  }
}
...
protocol ViewEventApiProtocol {
  func onMapClickEvent(viewId viewIdArg: Int64, latLng latLngArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onMapLongClickEvent(viewId viewIdArg: Int64, latLng latLngArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onRecenterButtonClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onMarkerEvent(viewId viewIdArg: Int64, markerId markerIdArg: String, eventType eventTypeArg: MarkerEventTypeDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onMarkerDragEvent(viewId viewIdArg: Int64, markerId markerIdArg: String, eventType eventTypeArg: MarkerDragEventTypeDto, position positionArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onPolygonClicked(viewId viewIdArg: Int64, polygonId polygonIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onPolylineClicked(viewId viewIdArg: Int64, polylineId polylineIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onCircleClicked(viewId viewIdArg: Int64, circleId circleIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onNavigationUIEnabledChanged(viewId viewIdArg: Int64, navigationUIEnabled navigationUIEnabledArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onMyLocationClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onMyLocationButtonClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onCameraChanged(viewId viewIdArg: Int64, eventType eventTypeArg: CameraEventTypeDto, position positionArg: CameraPositionDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class ViewEventApi: ViewEventApiProtocol {
  ...
  var codec: FlutterStandardMessageCodec {
    return ViewEventApiCodec.shared
  }
  func onMapClickEvent(viewId viewIdArg: Int64, latLng latLngArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMapClickEvent"
  ...
  func onMapLongClickEvent(viewId viewIdArg: Int64, latLng latLngArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMapLongClickEvent"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([viewIdArg, latLngArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  func onRecenterButtonClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onRecenterButtonClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onMarkerEvent(viewId viewIdArg: Int64, markerId markerIdArg: String, eventType eventTypeArg: MarkerEventTypeDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMarkerEvent"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onMarkerDragEvent(viewId viewIdArg: Int64, markerId markerIdArg: String, eventType eventTypeArg: MarkerDragEventTypeDto, position positionArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMarkerDragEvent"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([viewIdArg, markerIdArg, eventTypeArg.rawValue, positionArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
        return
      }
  ...
  func onPolygonClicked(viewId viewIdArg: Int64, polygonId polygonIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onPolygonClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onPolylineClicked(viewId viewIdArg: Int64, polylineId polylineIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onPolylineClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onCircleClicked(viewId viewIdArg: Int64, circleId circleIdArg: String, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onCircleClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onNavigationUIEnabledChanged(viewId viewIdArg: Int64, navigationUIEnabled navigationUIEnabledArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onNavigationUIEnabledChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onMyLocationClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMyLocationClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([viewIdArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  func onMyLocationButtonClicked(viewId viewIdArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onMyLocationButtonClicked"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([viewIdArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  func onCameraChanged(viewId viewIdArg: Int64, eventType eventTypeArg: CameraEventTypeDto, position positionArg: CameraPositionDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.ViewEventApi.onCameraChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
private class NavigationSessionApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return NavigationSessionApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return NavigationSessionApiCodecWriter(data: data)
  }
}
...
protocol NavigationSessionApi {
  ...
  func cleanup() throws
  func showTermsAndConditionsDialog(title: String, companyName: String, shouldOnlyShowDriverAwarenessDisclaimer: Bool, completion: @escaping (Result<Bool, Error>) -> Void)
...
class NavigationSessionApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NavigationSessionApi?) {
    /// General.
    let createNavigationSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.createNavigationSession", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isInitializedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.isInitialized", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cleanupChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.cleanup", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let showTermsAndConditionsDialogChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.showTermsAndConditionsDialog", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      showTermsAndConditionsDialogChannel.setMessageHandler { message, reply in
        ...
        api.showTermsAndConditionsDialog(title: titleArg, companyName: companyNameArg, shouldOnlyShowDriverAwarenessDisclaimer: shouldOnlyShowDriverAwarenessDisclaimerArg) { result in
          switch result {
            case .success(let res):
              reply(wrapResult(res))
            case .failure(let error):
    ...
    let areTermsAcceptedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.areTermsAccepted", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let resetTermsAcceptedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.resetTermsAccepted", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getNavSDKVersionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.getNavSDKVersion", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Navigation.
    let isGuidanceRunningChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.isGuidanceRunning", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let startGuidanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.startGuidance", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stopGuidanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.stopGuidance", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setDestinationsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.setDestinations", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearDestinationsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.clearDestinations", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let continueToNextDestinationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.continueToNextDestination", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCurrentTimeAndDistanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.getCurrentTimeAndDistance", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAudioGuidanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.setAudioGuidance", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setSpeedAlertOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.setSpeedAlertOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getRouteSegmentsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.getRouteSegments", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getTraveledRouteChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.getTraveledRoute", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCurrentRouteSegmentChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.getCurrentRouteSegment", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Simulation
    let setUserLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.setUserLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeUserLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.removeUserLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let simulateLocationsAlongExistingRouteChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.simulateLocationsAlongExistingRoute", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let simulateLocationsAlongExistingRouteWithOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.simulateLocationsAlongExistingRouteWithOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let simulateLocationsAlongNewRouteChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.simulateLocationsAlongNewRoute", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let simulateLocationsAlongNewRouteWithRoutingOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.simulateLocationsAlongNewRouteWithRoutingOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let simulateLocationsAlongNewRouteWithRoutingAndSimulationOptionsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.simulateLocationsAlongNewRouteWithRoutingAndSimulationOptions", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pauseSimulationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.pauseSimulation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let resumeSimulationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.resumeSimulation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Simulation (iOS only)
    let allowBackgroundLocationUpdatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.allowBackgroundLocationUpdates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Road snapped location updates.
    let enableRoadSnappedLocationUpdatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.enableRoadSnappedLocationUpdates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let disableRoadSnappedLocationUpdatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.disableRoadSnappedLocationUpdates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Enable Turn-by-Turn navigation events.
    let enableTurnByTurnNavigationEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.enableTurnByTurnNavigationEvents", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      enableTurnByTurnNavigationEventsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let numNextStepsToPreviewArg: Int64? = isNullish(args[0]) ? nil : (args[0] is Int64? ? args[0] as! Int64? : Int64(args[0] as! Int32))
        do {
    ...
    let disableTurnByTurnNavigationEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.disableTurnByTurnNavigationEvents", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let registerRemainingTimeOrDistanceChangedListenerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionApi.registerRemainingTimeOrDistanceChangedListener", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      registerRemainingTimeOrDistanceChangedListenerChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remainingTimeThresholdSecondsArg = args[0] is Int64 ? args[0] as! Int64 : Int64(args[0] as! Int32)
        let remainingDistanceThresholdMetersArg = args[1] is Int64 ? args[1] as! Int64 : Int64(args[1] as! Int32)
        do {
...
private class NavigationSessionEventApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return NavigationSessionEventApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return NavigationSessionEventApiCodecWriter(data: data)
  }
}

class NavigationSessionEventApiCodec: FlutterStandardMessageCodec {
  static let shared = NavigationSessionEventApiCodec(readerWriter: NavigationSessionEventApiCodecReaderWriter())
}

/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
protocol NavigationSessionEventApiProtocol {
  func onSpeedingUpdated(msg msgArg: SpeedingUpdatedEventDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onRoadSnappedLocationUpdated(location locationArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onRoadSnappedRawLocationUpdated(location locationArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onArrival(waypoint waypointArg: NavigationWaypointDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onRouteChanged(completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onRemainingTimeOrDistanceChanged(remainingTime remainingTimeArg: Double, remainingDistance remainingDistanceArg: Double, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Android-only event.
  ...
  /// Android-only event.
  func onGpsAvailabilityUpdate(available availableArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void)
  /// Turn-by-Turn navigation events.
  func onNavInfo(navInfo navInfoArg: NavInfoDto, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class NavigationSessionEventApi: NavigationSessionEventApiProtocol {
  ...
  var codec: FlutterStandardMessageCodec {
    return NavigationSessionEventApiCodec.shared
  }
  func onSpeedingUpdated(msg msgArg: SpeedingUpdatedEventDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onSpeedingUpdated"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onRoadSnappedLocationUpdated(location locationArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onRoadSnappedLocationUpdated"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onRoadSnappedRawLocationUpdated(location locationArg: LatLngDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onRoadSnappedRawLocationUpdated"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([locationArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  func onArrival(waypoint waypointArg: NavigationWaypointDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onArrival"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onRouteChanged(completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onRouteChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onRemainingTimeOrDistanceChanged(remainingTime remainingTimeArg: Double, remainingDistance remainingDistanceArg: Double, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onRemainingTimeOrDistanceChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  /// Android-only event.
  func onTrafficUpdated(completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onTrafficUpdated"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  /// Android-only event.
  func onRerouting(completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onRerouting"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName:channelName)))
  ...
  /// Android-only event.
  func onGpsAvailabilityUpdate(available availableArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onGpsAvailabilityUpdate"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  /// Turn-by-Turn navigation events.
  func onNavInfo(navInfo navInfoArg: NavInfoDto, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.NavigationSessionEventApi.onNavInfo"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
...
private class AutoMapViewApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return AutoMapViewApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return AutoMapViewApiCodecWriter(data: data)
  }
}
...
class AutoMapViewApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AutoMapViewApi?) {
    let isMyLocationEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isMyLocationEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMyLocationEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMyLocationEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMyLocationEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let getMyLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getMyLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMapTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getMapType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMapTypeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMapType", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMapTypeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let setMapStyleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMapStyle", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMapStyleChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let getCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getVisibleRegionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getVisibleRegion", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let followMyLocationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.followMyLocation", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      followMyLocationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let animateCameraToCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraToCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToCameraPositionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let cameraPositionArg = args[0] as! CameraPositionDto
        let durationArg: Int64? = isNullish(args[1]) ? nil : (args[1] is Int64? ? args[1] as! Int64? : Int64(args[1] as! Int32))
    ...
    let animateCameraToLatLngChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraToLatLng", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToLatLngChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let animateCameraToLatLngBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraToLatLngBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToLatLngBoundsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let animateCameraToLatLngZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraToLatLngZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToLatLngZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pointArg = args[0] as! LatLngDto
    ...
    let animateCameraByScrollChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraByScroll", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraByScrollChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let animateCameraByZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraByZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraByZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let animateCameraToZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.animateCameraToZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      animateCameraToZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let moveCameraToCameraPositionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraToCameraPosition", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraToCameraPositionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let cameraPositionArg = args[0] as! CameraPositionDto
    ...
    let moveCameraToLatLngChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraToLatLng", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraToLatLngChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pointArg = args[0] as! LatLngDto
    ...
    let moveCameraToLatLngBoundsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraToLatLngBounds", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraToLatLngBoundsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let boundsArg = args[0] as! LatLngBoundsDto
    ...
    let moveCameraToLatLngZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraToLatLngZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraToLatLngZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pointArg = args[0] as! LatLngDto
    ...
    let moveCameraByScrollChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraByScroll", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraByScrollChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let scrollByDxArg = args[0] as! Double
    ...
    let moveCameraByZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraByZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraByZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let zoomByArg = args[0] as! Double
    ...
    let moveCameraToZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.moveCameraToZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      moveCameraToZoomChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let zoomArg = args[0] as! Double
    ...
    let getMinZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getMinZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let resetMinMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.resetMinMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setMinZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMinZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMinZoomPreferenceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let setMaxZoomPreferenceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMaxZoomPreference", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMaxZoomPreferenceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let setMyLocationButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMyLocationButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMyLocationButtonEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setConsumeMyLocationButtonClickEventsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setConsumeMyLocationButtonClickEventsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setConsumeMyLocationButtonClickEventsEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setZoomGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setZoomGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setZoomGesturesEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setZoomControlsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setZoomControlsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setZoomControlsEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setCompassEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setCompassEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setCompassEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setRotateGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setRotateGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setRotateGesturesEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setScrollGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setScrollGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setScrollGesturesEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setScrollGesturesDuringRotateOrZoomEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setScrollGesturesDuringRotateOrZoomEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setScrollGesturesDuringRotateOrZoomEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setTiltGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setTiltGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setTiltGesturesEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setMapToolbarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setMapToolbarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMapToolbarEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let setTrafficEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setTrafficEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setTrafficEnabledChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
    ...
    let isMyLocationButtonEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isMyLocationButtonEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isConsumeMyLocationButtonClickEventsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isConsumeMyLocationButtonClickEventsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isZoomGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isZoomGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isZoomControlsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isZoomControlsEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isCompassEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isCompassEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isRotateGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isRotateGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isScrollGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isScrollGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isScrollGesturesEnabledDuringRotateOrZoomChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isScrollGesturesEnabledDuringRotateOrZoom", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTiltGesturesEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isTiltGesturesEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isMapToolbarEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isMapToolbarEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isTrafficEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isTrafficEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.addMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addMarkersChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let updateMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.updateMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateMarkersChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let markersArg = args[0] as! [MarkerDto]
    ...
    let removeMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.removeMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removeMarkersChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let markersArg = args[0] as! [MarkerDto]
    ...
    let clearMarkersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.clearMarkers", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.clear", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.addPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addPolygonsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let updatePolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.updatePolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updatePolygonsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let polygonsArg = args[0] as! [PolygonDto]
    ...
    let removePolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.removePolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removePolygonsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let polygonsArg = args[0] as! [PolygonDto]
    ...
    let clearPolygonsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.clearPolygons", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.addPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addPolylinesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let updatePolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.updatePolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updatePolylinesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let polylinesArg = args[0] as! [PolylineDto]
    ...
    let removePolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.removePolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removePolylinesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let polylinesArg = args[0] as! [PolylineDto]
    ...
    let clearPolylinesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.clearPolylines", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.addCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      addCirclesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let updateCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.updateCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      updateCirclesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let circlesArg = args[0] as! [CircleDto]
    ...
    let removeCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.removeCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      removeCirclesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let circlesArg = args[0] as! [CircleDto]
    ...
    let clearCirclesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.clearCircles", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let enableOnCameraChangedEventsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.enableOnCameraChangedEvents", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isAutoScreenAvailableChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.isAutoScreenAvailable", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.setPadding", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setPaddingChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let getPaddingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.google_navigation_flutter.AutoMapViewApi.getPadding", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
private class AutoViewEventApiCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return AutoViewEventApiCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return AutoViewEventApiCodecWriter(data: data)
  }
}
...
protocol AutoViewEventApiProtocol {
  func onCustomNavigationAutoEvent(event eventArg: String, data dataArg: Any, completion: @escaping (Result<Void, FlutterError>) -> Void)
  func onAutoScreenAvailabilityChanged(isAvailable isAvailableArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void)
}
class AutoViewEventApi: AutoViewEventApiProtocol {
  ...
  var codec: FlutterStandardMessageCodec {
    return AutoViewEventApiCodec.shared
  }
  func onCustomNavigationAutoEvent(event eventArg: String, data dataArg: Any, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.AutoViewEventApi.onCustomNavigationAutoEvent"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func onAutoScreenAvailabilityChanged(isAvailable isAvailableArg: Bool, completion: @escaping (Result<Void, FlutterError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.google_navigation_flutter.AutoViewEventApi.onAutoScreenAvailabilityChanged"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
